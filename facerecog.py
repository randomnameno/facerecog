...
known_image = face_recognition.load_image_file("assets/akhil.jpg")
unknown_image = face_recognition.load_image_file("unknown/rohit.jpg")
...
# cur_direc = os.getcwd()
# print(cur_direc)
# path = os.path.join(cur_direc, 'assets/')
# print(path)
